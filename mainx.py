...
#     if input_image_path: #and "occulation overlay" in user_message.lower():
...
#             python_executable = "/mnt/c/development/Thesis/PotatoDiseaseClassification-CNN/linux-venv/bin/python"
#             my_env = os.environ.copy()
#             venv_packages = "/mnt/c/development/Thesis/Gastrovision/linux-venv/lib/python3.12/site-packages"
#             cuda_paths = f"/usr/lib/wsl/lib:{venv_packages}/nvidia/cudnn/lib:{venv_packages}/nvidia/cublas/lib:{venv_packages}/nvidia/cuda_runtime/lib:{venv_packages}/nvidia/cusolver/lib:{venv_packages}/nvidia/cusparse/lib"
#             my_env["LD_LIBRARY_PATH"] = f"{cuda_paths}:{my_env.get('LD_LIBRARY_PATH', '')}"
